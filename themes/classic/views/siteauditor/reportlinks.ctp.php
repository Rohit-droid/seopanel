...
<table style="width:100%;" border="0" cellspacing="0px" cellpadding="0px" align="center" class="report_head" id="audit_report_project_url_RR">
	<tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list auditor-Page-RR" style="<?php echo $borderCollapseVal; ?>">
	<tr class="plainHead">
		<td class="left"><?php echo $page_urlLink?></td>
	...
	if(count($list) > 0){
		...
		foreach($list as $i => $listInfo){
			...
			<tr class="<?php echo $class?>">
				<td id="cts-link" class="<?php echo $leftBotClass?> left"><?php echo $pageLink?></td>
				...
				<?php if (empty($pdfVersion) && empty($printVersion)) {?>
					<td class="<?php echo $rightBotClass?>">
					    <select style="width: 115px;" name="action" id="action<?php echo $listInfo['id']?>" onchange="doAction('siteauditor.php', 'subcontent', 'report_id=<?php echo $listInfo['id']?>&pageno=<?php echo $pageNo?>&order_col=<?php echo $orderCol?>&order_val=<?php echo $orderVal?>', 'action<?php echo $listInfo['id']?>')">
