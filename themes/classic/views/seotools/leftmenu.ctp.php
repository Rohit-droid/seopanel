...
foreach($menuList as $i => $menuInfo){
	...
	<li class="tab" style="display:flex;" onclick="showMenu('<?php echo $button?>','<?php echo $subMenuId?>')">
		<span style="margin-right:10px;" id="<?php echo $button?>" class="<?php echo $menuClass?>"></span>
		<a style="margin: auto 0;" href='javascript:void(0);'>
